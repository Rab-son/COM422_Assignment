...
def breadthFirstSearch(problem):
    ...
    "*** YOUR CODE HERE ***"
    # Using a Queue, so that the searching explores all nodes on one level before moving to
    # the next level 
    # Made an empty list of explored nodes called visited = []
    # Made an empty list of actions called actionList
    fringe = util.Queue()
    visited = []
    actionList = []
...
def uniformCostSearch(problem):
    ...
    "*** YOUR CODE HERE ***"
    # Using a PriorityQueue, so the cost of actions is calculated with a provided heuristic
    # Make an empty list of explored nodes called visited
    # Make an empty list of actions called actionList
